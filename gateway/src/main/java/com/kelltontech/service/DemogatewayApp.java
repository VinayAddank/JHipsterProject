...
import com.kelltontech.service.config.ApplicationProperties;
import com.kelltontech.service.config.DefaultProfileUtil;
...
public class DemogatewayApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(DemogatewayApp.class);

    private final Environment env;

    public DemogatewayApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes demogateway.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(DemogatewayApp.class);
